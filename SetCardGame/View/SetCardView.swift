...
class SetCardView: UIView {
    ...
    private func stripeRect(_ rect: CGRect) {
        ...
        for _ in 1...stripeCount {
            let translation = CGAffineTransform(
                translationX: interStripeSpace, y: 0)
    ...
    private func configureState() {
        ...
        if isSelected {
            ...
            layer.borderColor = Colors.defaultColor
        }
    ...
    override func layoutSubviews() {
        ...
        pinLabel.frame.origin = bounds.origin.offsetBy(
            dx: bounds.size.width * pinOffSet,
    ...
    private struct Colors {
        ...
        static let selected = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1).cgColor //instead of #colorLiteral(red: 1, green: 0.5763723254, blue: 0, alpha: 1)
        static let matched = #colorLiteral(red: 0, green: 0.9914394021, blue: 1, alpha: 1).cgColor
        static var misMatched = #colorLiteral(red: 0.9254902005, green: 0.2352941185, blue: 0.1019607857, alpha: 1).cgColor //instead of black
        static let hint = #colorLiteral(red: 1, green: 0.5212053061, blue: 1, alpha: 1).cgColor
        static let defaultColor = #colorLiteral(red: 1, green: 0.5212053061, blue: 1, alpha: 0).cgColor
    }
}
